...
var lyr_LeachateFlowsgalyear_10 = new ol.layer.Vector({
    ...
    <img src="styles/legend/LeachateFlowsgalyear_10_1.png" /> 3,000,000 - 10,000,000<br />\
    <img src="styles/legend/LeachateFlowsgalyear_10_2.png" /> 10,000,000 - 22,000,000<br />'
        });
...
var lyr_LandfillsContributingLeachategalyear_11 = new ol.layer.Vector({
    ...
    <img src="styles/legend/LandfillsContributingLeachategalyear_11_0.png" /> < 2,000,000<br />\
    <img src="styles/legend/LandfillsContributingLeachategalyear_11_1.png" /> 2,000,000 - 8,000,000<br />\
    <img src="styles/legend/LandfillsContributingLeachategalyear_11_2.png" /> 8,000,000 - 26,000,000<br />'
        });
...
var lyr_WWTPsReceivingLeachategalyear_12 = new ol.layer.Vector({
    ...
    <img src="styles/legend/WWTPsReceivingLeachategalyear_12_1.png" /> 4,000,000 - 16,000,000<br />\
    <img src="styles/legend/WWTPsReceivingLeachategalyear_12_2.png" /> 16,000,000 - 47,000,000<br />'
        });
...
var lyr_DrinkingWaterIntakespopserved_13 = new ol.layer.Vector({
    ...
    <img src="styles/legend/DrinkingWaterIntakespopserved_13_0.png" /> 2,000 - 13,000<br />\
    <img src="styles/legend/DrinkingWaterIntakespopserved_13_1.png" /> 13,000 - 36,000<br />\
    <img src="styles/legend/DrinkingWaterIntakespopserved_13_2.png" /> 36,000 - 86,000<br />'
        });
...
lyr_LeachateFlowsgalyear_10.set('fieldAliases', {'id': 'id', 'src_name': 'Landfill Name', 'dest_name': 'WWTP Name', 'avg_gal_yr': 'Leachate Gallons/Year (Average)', 'avg_gal_day': 'Leachate Gallons/Day (Average)', 'avg_cost_gal': 'Cost/Gallon (Average)', 'dest_spdes': 'dest_spdes', });
...
lyr_LeachateFlowsgalyear_10.set('fieldImages', {'id': 'TextEdit', 'src_name': 'TextEdit', 'dest_name': 'TextEdit', 'avg_gal_yr': 'TextEdit', 'avg_gal_day': 'TextEdit', 'avg_cost_gal': 'TextEdit', 'dest_spdes': 'TextEdit', });
