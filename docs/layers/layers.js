...
//ol.proj.get("EPSG:6347").setExtent([452410.604700, 4554569.955152, 707723.082800, 4839012.044848]);
var wms_layers = [];
...
lyr_LeachateFlowsgalyear_10.set('fieldLabels', {'id': 'hidden field', 'src_name': 'inline label - always visible', 'dest_name': 'inline label - always visible', 'year_start': 'no label', 'year_end': 'no label', 'avg_gal_yr': 'inline label - always visible', 'avg_gal_day': 'inline label - always visible', 'avg_cost_gal': 'inline label - always visible', 'dest_spdes': 'hidden field', });
