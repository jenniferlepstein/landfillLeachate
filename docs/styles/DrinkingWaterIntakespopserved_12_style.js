...
var style_DrinkingWaterIntakespopserved_12 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("intake_f_name") !== null && resolution > 0 && resolution < 336) {
        labelText = String(feature.get("intake_f_name"));
    }
